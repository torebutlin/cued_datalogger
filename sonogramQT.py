...
def sonogram(signal, t):
    ...
    sonogram_plotWidget = pg.plot(title="Sonogram")
    sonogram_plotWidget.plot(F_bins, T_bins, FT)
...
signal_plotWidget = pg.plot(title="Signal")
signal_plotWidget.plot(t, signal)
